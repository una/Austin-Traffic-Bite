...
!function(e,o){"undefined"!=typeof module&&module.exports?module.exports=o():"function"==typeof define&&define.amd?define(o):this[e]=o()}("Routely",function(){function e(){t=this,this.routes=[],window.onload=o,window.onhashchange=o}function o(){var e=window.location.hash.slice(1)||"/";try{if(void 0!==t.routes[e])t.routes[e].controller.call();else for(var o in t.routes)if("/"!==o&&t.routes[o].getRegExp().test(e)){var r=t._getRouteParams(t.routes[o].getRegExp(),e);t.routes[o].controller.apply(t,r)}}catch(n){console.error(n.message)}}var t;return e.prototype={route:function(e,o){var t=this._routeToRegex(e);return this.routes[e]={controller:o,getRegExp:function(){return t}},this},_routeToRegex:function(e){return e=e.replace(/:\w+/g,"([^/?]+)"),new RegExp("^"+e+"(?:\\?([\\s\\S]*))?$")},_getRouteParams:function(e,o){var t=e.exec(o).slice(1);return t}},e});
!function(t){function e(){}t(document).ready(function(){var o=new Routely,a=new e,s=null,r=t("#header");o.route("/",function(){s='<a href="#/mopac"> check mopac</a><h1 class="center">IH-35 Traffic</h1>',r.html(s),a.clearResults(),a.NBIH35(),a.SBIH35()}),o.route("/mopac",function(){s='<a href="#/"> check IH-35</a><h1 class="center">Mopac Traffic</h1>',r.html(s),a.clearResults(),a.NBMopac(),a.SBMopac()})}),e.prototype={nbEl:t("#nb-circle"),sbEl:t("#sb-circle"),colors:{red:"#EF4836",green:"#68C3A3",orange:"#FDE3A7"},phrases:{positive:["Willie Nelson","smooth sailing","In the clear"],negative:["Not cool","Not worth it","It's crazy out there"],neutral:["meh","mediocre","meh"]},phrasesCount:3,start:function(){},getTravelData:function(e,o){var a=e.join(","),s=o.join(",");return t.ajax({type:"GET",dataType:"JSON",url:"http://www.mapquestapi.com/directions/v2/route?key=Fmjtd%7Cluur25utnq%2Cb0%3Do5-9w70lf&from="+a+"&to="+s+"&callback=&timeType=1&useTraffic=true"})},displayTravelResults:function(e,o,a){var s=Math.floor(Math.random()*this.phrasesCount),r=t("<span class='circle-text'>"),l=60,n=e.route.realTime,c=o;c+.5*l>n?(r.text(this.phrases.positive[s]),a.css("background-color",this.colors.green).html(r)):n>=c+.5*l&&c+2*l>=n?(r.text(this.phrases.neutral[s]),a.css("background-color",this.colors.orange).html(r)):n>c+2*l?(r.text(this.phrases.negative[s]),a.css("background-color",this.colors.red).html(r)):(r.text("No information at this time"),a.html(r))},clearResults:function(){this.nbEl.css("background-color","#eee").html(""),this.sbEl.css("background-color","#eee").html("")},NBIH35:function(){var t=this;this.getTravelData([30.2174376,-97.7498557],[30.3388355,-97.700168]).done(function(e){console.log("nb 35 ",e.route),t.displayTravelResults(e,700,t.nbEl)})},SBIH35:function(){var t=this;this.getTravelData([30.338827,-97.700487],[30.217247,-97.751079]).done(function(e){console.log("sb 35 ",e.route),t.displayTravelResults(e,600,t.sbEl)})},NBMopac:function(){var t=this;this.getTravelData([30.257323,-97.799138],[30.374919,-97.739824]).done(function(e){console.log("nb mopac ",e.route),t.displayTravelResults(e,756,t.nbEl)})},SBMopac:function(){var t=this;this.getTravelData([30.374041,-97.740324],[30.242744,-97.811671]).done(function(e){console.log("sb mopac ",e.route),t.displayTravelResults(e,830,t.sbEl)})}}}(jQuery);